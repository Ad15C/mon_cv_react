                    ...
                    <h6 className="fw-bold text-start">John Doe</h6>
                        <address className="custom-adress" >
                            ...
                            <div className="d-flex align-items-center ps-0 m-0">
                                ...
                                <FontAwesomeIcon icon={faGithub}  className="text-black" id="networks-Github"/>
                                </Link>                 
                                ...
                                <a 
                                    ...
                                    aria-label="Twitter"
                                    rel="nofollow">
                                        <FontAwesomeIcon icon={faTwitterSquare} className="text-black" id="networks-Twitter"/>
                                </a>
                                ...
                                <a 
                                    ...
                                    aria-label="LinkedIn"
                                    rel="nofollow">
                                        <FontAwesomeIcon icon={faLinkedinIn} className="text-black" id="networks-Linkedin"/>
                                </a>
                            </div>
                </div>
