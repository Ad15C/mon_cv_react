        ...
        <section className="presentation">
            <div className="background-image">
                <div className="container text-center text-white">
                    <div className="row">
                        <div className="col">
                            <h1 className="text-center text-white" id="presentation-title">Bonjour, je suis John Doe</h1>
                                <h2 className="text-center text-white" id="title-2">Développeur web full stack</h2>
                                    <a href="#about" className="mt-4 btn btn-primary">
                                        En savoir plus
                                    </a>
                        </div>
                    </div>
            ...
            <div className="container col-lg-10 col-md- 12 shadow p-3 mb-5 bg-white rounded">
                <div className="row ">
