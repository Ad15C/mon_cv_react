import { faEnvelope, faGlobe, faLocationDot, faMobile, faMobilePhone } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <main className="mentions">
            <div className="container mb-5">
                <h1 className="text-uppercase mt-5 mb-5">Mentions légales</h1>
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body ">
                                        ...
                                        <address className="text-start p-1 lh-2 mb-0">
                                            <p className="mb-0 fw-semibold"><FontAwesomeIcon icon={faLocationDot} /> 40 Rue Laure Diebold<br></br>69009 Lyon, France</p>
                                            <p className="text-primary mb-0 fw-semibold fs-6"><FontAwesomeIcon icon={faMobile}  className=" text-black"/> 06 20 30 40 50 </p>
                                            <p className="text-primary mb-0 fw-semibold fs-6">
                                            <FontAwesomeIcon icon={faEnvelope} className="text-black"/> john.doe@gmail.com
                                            </p>
                                        </address>
                                    </div>
                                    </div>
                            ...
                            <h2 class="accordion-header">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body text-start p-1 lh-2 mt-2 mb-3">
                                        ...
                                        <address className=" ms-2 lh-1 fw-semibold fs-6 text">
                                            91 rue du Faubourd Saint Honoré<br></br>
                                            75008 Paris
                                        </address>
                                        <p className="text-primary mb-0 ms-2 fw-semibold "><FontAwesomeIcon icon={faGlobe} className="text-black"/> www.alwaysdata.com</p>
                                    </div>
                                </div>
                        </div>
                        <div class="accordion-item">
