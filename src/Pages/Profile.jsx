...
const Profile = () => {
    return (
        <div className="container bg-white mt-5 mb-5 p-5">
            ...
            <h2 className="fw-bold">Github user</h2>
            <h3 className="fw-semibold">John Doe</h3>
            </div>
            <div className="container-body ">
                <img src="github.png" alt="photo du profil Github" id="Github_img"/>
                ...
                <ul className="lh-lg">
                    ...
                    <li className="github-list">Créé le : 2016-06-09T17:14:00Z</li>
                    <li className="github-list">Modifié le : 2021-10-12T05:01:09Z</li>
