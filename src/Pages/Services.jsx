                        ...
                        <div className="card h-100 .bg-white" >
                            <div className="card-body mt-5 mb-5">
                                <FontAwesomeIcon 
                                    ...
                                    id="desktop"
                                />
                                <h5 className="card-title text-uppercase fw-bold">UX Design</h5>
                ...
                <div className="col" id="services">
                    <div className="card h-100">
                        ...
                        <FontAwesomeIcon 
                            ...
                            id="FileCode"
                        />
                        <h5 className="card-title text-uppercase fw-bold">Développement Web</h5>
                                <p className="card-text text-center">Le <strong>développement de sites web</strong>
                    ...
                    <div className="card h-100">
                        <div className="card-body mt-5 mb-5">
                            <FontAwesomeIcon 
                                ...
                                id="Glass"
                            />
                            <h5 className="card-title text-uppercase fw-bold">Référencement</h5>
                                <p className="card-text text-center">Le <strong>référencement naturel d'un site</strong>, 
